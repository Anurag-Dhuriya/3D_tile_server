    ...
    try:
        ...
        if analysis:
            print(
                ...
                f"complexity={analysis.get('geometric_complexity', 0):.3f}, "
                f"fine={analysis.get('fine_detail_score', 0):.3f}, "
                f"repetition={analysis.get('repeated_structure_score', 0):.3f}, "
                f"parts={analysis.get('disconnected_parts', 1)}"
            )
